...
<head>
    ...
    <title>Admin Login | MRA Clearance System</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">
    <style>
        body {
            background: linear-gradient(120deg, #003366 0%, #00796b 100%);
            min-height: 100vh;
            display: flex;
        ...
        <div class="auth-container">
            ...
            <form method="post" action="admin-dashboard.php" autocomplete="off">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="adminUsername" name="username" required autofocus>
                </div>
                <div class="mb-3">
