...
<section class="hero-section">
    ...
    <div class="nav-btns">
        <a href="/admin-login" class="btn btn-primary btn-lg"><i class="fas fa-user-shield me-2"></i>Admin</a>
        <a href="/agent-login" class="btn btn-success btn-lg"><i class="fas fa-user-tie me-2"></i>Agent</a>
        <a href="/keeper-login" class="btn btn-warning btn-lg text-white"><i class="fas fa-user-shield me-2"></i>Keeper</a>
        <a href="/client-login" class="btn btn-info btn-lg text-white"><i class="fas fa-user me-2"></i>Client</a>
    </div>
</section>
